...
+function ($) {
  ...
  BFHNumber.prototype = {
    ...
    initInput: function initInput() {
      ...
      if (this.options.buttons === true) {
        this.$element.parent().on('touchstart.bfhnumber.data-api mousedown.bfhnumber.data-api', '.inc', BFHNumber.prototype.btninc).on('touchstart.bfhnumber.data-api mousedown.bfhnumber.data-api', '.dec', BFHNumber.prototype.btndec);
      }
