...
<head>
    ...
    <meta name="description" content="Самый крутой бар на свете - Капчо!">
    <link rel="stylesheet" href="/css/app.css">
    <title>КАПЧО? БАР</title>
</head>
<body>
...
<header class="kapcho-header">
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbar">
                ...
                <ul class="nav navbar-nav">
                    <li><a class="page-scroll" href="#cho-v-kapcho">Чо в Капчо?</a></li>
    ...
    <div class="kapcho-info">
        ...
        <div class="social-links">
            <a href="https://www.facebook.com/kapchobar" target="_blank">
            ...
            <a href="https://www.instagram.com/kapchobar" target="_blank">
            ...
            <a href="https://vk.com/kapchobar" target="_blank">
                <svg enable-background="new 0 0 128 128" version="1.1" viewBox="0 0 112.196 112.196"
                        xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <g>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="footer-icons col-sm-4">
                ...
                <a href="https://www.instagram.com/kapchobar" title="Instagram" target="_blank" class="kap-block-footer-ico">
                ...
                <a href="https://vk.com/kapchobar" title="VK" target="_blank" class="kap-block-footer-ico">
